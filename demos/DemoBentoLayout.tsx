  ...
  const TABLE_DATA = [
    ...
    },
    {
      ...
      data: [
        ...
        <H3>
          ...
          <TextSwapper animationType="blur" strings={['back', 'as well', 'too', 'in unison']} style={containerStyles} />
        </H3>,
      ],
    },
    {
    ...
    },
    {
      ...
      data: [
        ...
        <H3>
          The visions are clear now. I see possible <TextSwapper animationType="slideRight" strings={['futures', 'meals', 'lovers', 'wars']} style={containerStyles} />, all at
          once
        </H3>,
      ],
    },
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.bento}>
        ...
        <div className={styles.row}>
          <LineChart data={EXAMPLE_DUMMY_DATA} style={{ marginTop: 32 }} showErrorBars={false} showConfidenceIntervalFill={false} showAreaFill={true} />
        </div>
        <div className={styles.row}>
          <div className={styles.columnWide}>
